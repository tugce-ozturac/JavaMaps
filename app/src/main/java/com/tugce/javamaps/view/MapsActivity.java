...
import com.tugce.javamaps.databinding.ActivityMapsBinding;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,GoogleMap.OnMapLongClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerLauncher();
        sharedPreferences = MapsActivity.this.getSharedPreferences("com.tugce.javamaps", MODE_PRIVATE);
        info = false;

        db = Room.databaseBuilder(getApplicationContext(), PlaceDatabase.class, "Places")
                // .allowMainTh      readQueries()
                .build();
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if(intentInfo.equals("new")){
            ...
            mMap.setMyLocationEnabled(true);  //benim konumumun doğru olduğundan emin ol mavı konum yeri
